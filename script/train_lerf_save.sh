...
python train_save.py    -s $dataset_folder -r ${scale}  -m output/${dataset_name}_rmft --config_file config/gaussian_dataset/train.json --train_split --start_pointcloud /scratch/jiasi_root/jiasi98/zxuechen/dataset_segmentation/checkpoint/${dataset_name} --prune_iterations 2 --port 6006
