...
if __name__ == "__main__":
    ...
    parser.add_argument("--loaded_iteration", default=30000, type=int)
    ...
    parser.add_argument("--checkpoint_iterations", nargs="+", type=int, default=[29_000, 60_000])
    parser.add_argument("--prune_iterations", nargs="+", type=int, default=[30_000])
